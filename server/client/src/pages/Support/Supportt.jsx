...
//     if (socketIO) {
//       socketIO.emit("joinRoom", { name: user.name, role: user.role });
      
//       socketIO.on("chatStarted", (data) => {
//         console.log(data.userId);
//       });

//       socketIO.on("receiveMessage", ({ message, sender }) => {
//         const receivedMessage = {
//           message,
//           user: sender,
//           time: new Date().toLocaleString(),
...
//       };
//     }
//   }, [user, socketIO, SocketIO, dispatch]);
